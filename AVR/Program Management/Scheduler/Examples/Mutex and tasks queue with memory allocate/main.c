...
// Каждая из задач добавляет в очередь задание на отправку своих данных,
...
// -------------------------------------------------------------------------------
//
// В ОТЛИЧИИ ОТ ПРОШЛОГО ПРИМЕРА, ЗДЕСЬ ПОКАЗАН ПРИМЕР С ВЫДЕЛЕНИЕМ
//
// ПАМЯТИ ДЛЯ ОЧЕРЕДИ ЗАДАЧ В ДИНАМИЧЕСКОЙ ПАМЯТИ (КУЧЕ)
//
// -------------------------------------------------------------------------------
//
...
// -------------------------------------------------------------------------------
//
// UNLIKE THE PREVIOUS EXAMPLE, HERE IS AN EXAMPLE OF ALLOCATING MEMORY
//
// FOR A TASK QUEUE IN DYNAMIC MEMORY (HEAP)
//
// ===============================================================================
...
// создаём статическую переменную-указатель на очередь задач
// -------------------------------------------------------------------------------
// creating a static variable-a pointer to the task queue
//
...
int main(void)
{
	...
	// выделение памяти в куче под очередь размером 3 и её инициализация
	// -------------------------------------------------------------------------------
