...
//  Description         : Declarations functions and macros for working with the RTC DS1307 chip        -
// ======================================================================================================
...
void DS1307_Set_Hours_In_24Hour_Mode(uint8_t hours);
...
// (56 bytes are available). Memory addresses - from 0x00 to 0x37
