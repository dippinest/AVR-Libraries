...
// ===============================================================================
//
// Библиотека для работы с семисегментным дисплеем на TM1637. Библиотека позволяет
// работать как с одиночным индикатором TM1637, так и с их множеством
// (это настраивается в файле tm1637_configuration.h)
//
// -------------------------------------------------------------------------------
//
