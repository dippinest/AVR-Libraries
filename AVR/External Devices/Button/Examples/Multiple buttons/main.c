...
int main(void)
{
	...
	//
	Button_t button1 = Button_Get_Device_Object(T(DDRD), T(PIND), 2, BUTTON_INPUT_PULLUP);
	Button_t button2 = Button_Get_Device_Object(T(DDRD), T(PIND), 3, BUTTON_INPUT_PULLUP);
	Button_t button3 = Button_Get_Device_Object(T(DDRD), T(PIND), 4, BUTTON_INPUT_PULLUP);
