...
int main(void)
{
	...
	encoder1 = Encoder_EXINT_Create_Object(T(DDRD), T(PIND), 2, T(DDRA), T(PINA), 2, Encoder1_Left, Encoder1_Right);
	encoder2 = Encoder_EXINT_Create_Object(T(DDRD), T(PIND), 3, T(DDRA), T(PINA), 3, Encoder2_Left, Encoder2_Right);
