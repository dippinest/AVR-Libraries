...
// старых моделей микроконтроллеров отсутсвует АЦП). В таком случае одним из решений
...
// и дальнейшей его зарядке через резистор R с замеров времени его заряда. Поскольку
