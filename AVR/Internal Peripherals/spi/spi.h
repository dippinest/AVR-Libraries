...
/*
#define SPI_SPEED_MACROS_FCPU_DIVIDED_BY_2    4
#define SPI_SPEED_MACROS_FCPU_DIVIDED_BY_4    0
#define SPI_SPEED_MACROS_FCPU_DIVIDED_BY_8    5
#define SPI_SPEED_MACROS_FCPU_DIVIDED_BY_16   1
#define SPI_SPEED_MACROS_FCPU_DIVIDED_BY_32   6
#define SPI_SPEED_MACROS_FCPU_DIVIDED_BY_64   2
#define SPI_SPEED_MACROS_FCPU_DIVIDED_BY_128  3
*/
