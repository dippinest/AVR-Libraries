...
int main(void)
{
	...
	//
	// soft I2C delay = 10
	SOFTI2C_t i2c_1 = SOFTI2C_Get_Interface_Object(_T(DDRD), _T(PIND), _T(PORTD), 5, _T(DDRD), _T(PIND), _T(PORTD), 6, 10);
	...
	//
	// soft I2C delay = 10
	SOFTI2C_t i2c_2 = SOFTI2C_Get_Interface_Object(_T(DDRA), _T(PINA), _T(PORTA), 0, _T(DDRA), _T(PINA), _T(PORTA), 1, 10);
