...
int main(void)
{
	...
	softpwm[0] = SOFTPWM_Get_Object(T(PORTB), 1, MAX_PWM_WIDTH, MAX_PWM_WIDTH);
	softpwm[1] = SOFTPWM_Get_Object(T(PORTB), 2, MAX_PWM_WIDTH, MAX_PWM_WIDTH);
	softpwm[2] = SOFTPWM_Get_Object(T(PORTB), 3, MAX_PWM_WIDTH, MAX_PWM_WIDTH);
