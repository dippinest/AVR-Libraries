...
// ===============================================================================
//
// Ѕиблиотека дл€ работы с внутренней EEPROM пам€тью микроконтроллера.
//
// ¬нимание! –абота с внутренней EEPROM - длительные по времени
// (особенно запись данных). ѕоэтому если вам надо записать или
// прочитать большой блок данных, € рекомиендую делать это
// с помощью конечного автомата
// (использу€, к примеру, библиотеку планировщика задач scheduler.h)
//
// -------------------------------------------------------------------------------
//
