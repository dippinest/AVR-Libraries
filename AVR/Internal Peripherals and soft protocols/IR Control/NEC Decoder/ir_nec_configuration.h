...
#ifndef IR_NEC_CONFIGURATION_H_
#define IR_NEC_CONFIGURATION_H_
...
#define IR_NEC_EXINT_IN_GPIO_DDR   DDRD
#define IR_NEC_EXINT_IN_GPIO_PINX  PIND
#define IR_NEC_EXINT_IN_GPIO_PIN   2
...
#define IR_NEC_EXINT_VECTOR_INTERRUPT INT0_vect
#define IR_NEC_TIMER_VECTOR_INTERRUPT TIMER2_COMP_vect
...
inline void IR_NEC_FSM_Timer_Initialize()
{
	TIMSK = (1 << OCIE2);
...
inline void IR_NEC_EXINT_Interrupt_Initialize()
{
	GICR  |= (1 << INT0);
