...
#ifndef NEC_IR_DECODER_CONFIGURATION_H_
#define NEC_IR_DECODER_CONFIGURATION_H_
...
//
#define NEC_IR_DECODER_EXINT_IN_GPIO_DDR   DDRD
#define NEC_IR_DECODER_EXINT_IN_GPIO_PINX  PIND
#define NEC_IR_DECODER_EXINT_IN_GPIO_PIN   2
...
//
#define NEC_IR_DECODER_EXINT_VECTOR_INTERRUPT INT0_vect
#define NEC_IR_DECODER_TIMER_VECTOR_INTERRUPT TIMER2_COMP_vect
...
//
inline void NEC_IR_Decoder_FSM_Timer_Interrupt_Initialize()
{
	TIMSK = (1 << OCIE2);
...
// (these settings are relevant for ATmega32A, 16 MHz)
//
inline void NEC_IR_Decoder_EXINT_Interrupt_Initialize()
{
	GICR  |= (1 << INT0);
