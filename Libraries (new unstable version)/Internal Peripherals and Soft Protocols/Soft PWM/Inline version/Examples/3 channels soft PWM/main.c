...
int main(void)
{
	...
	SOFTPWM_Inline_Initialize_Object(&(softpwm[0]), T(PORTB), 1, MAX_PWM_WIDTH, MAX_PWM_WIDTH);
	SOFTPWM_Inline_Initialize_Object(&(softpwm[1]), T(PORTB), 2, MAX_PWM_WIDTH, MAX_PWM_WIDTH);
	SOFTPWM_Inline_Initialize_Object(&(softpwm[2]), T(PORTB), 3, MAX_PWM_WIDTH, MAX_PWM_WIDTH);
