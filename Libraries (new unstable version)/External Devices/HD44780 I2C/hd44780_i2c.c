...
static HD44780_I2C_t *target_hd44780_i2c_object = NULL;
...
static void _HD44780_I2C_Write(uint8_t data)
{
	...
	_I2C_Send_Byte(target_hd44780_i2c_object->dev_addr << 1);
	_I2C_Send_Byte(data | 0b1000);
...
{
	(*hd44780_i2c).dev_addr = dev_addr;
	(*hd44780_i2c).entry_mode_display          = _HD44780_I2C_INITIAL_ENTRY_MODE_DISPLAY;
	(*hd44780_i2c).control_mode_display        = _HD44780_I2C_INITIAL_CONTROL_MODE_DISPLAY;
...
{
	return target_hd44780_i2c_object;
}
...
void HD44780_I2C_Set_Display_Enable(bool display_is_enable)
{
	...
	{
		target_hd44780_i2c_object->control_mode_display |=  (1 << _HD44780_I2C_CONTROL_MODE_DISPLAY_D_DISPLAY_ONOFF_BIT);
	}
	else
	{
		target_hd44780_i2c_object->control_mode_display &= ~(1 << _HD44780_I2C_CONTROL_MODE_DISPLAY_D_DISPLAY_ONOFF_BIT);
	...
	_HD44780_I2C_Send_Byte(target_hd44780_i2c_object->control_mode_display, _HD44780_I2C_DISPLAY_SEND_COMMAND_MODE); _delay_us(40);
}
...
void HD44780_I2C_Set_Cursor_Enable(bool cursor_is_enable)
{
	if (cursor_is_enable)
	{
		target_hd44780_i2c_object->control_mode_display |=  (1 << _HD44780_I2C_CONTROL_MODE_DISPLAY_C_CURSOR_ONOFF_BIT);
	}
	else
	{
		target_hd44780_i2c_object->control_mode_display &= ~(1 << _HD44780_I2C_CONTROL_MODE_DISPLAY_C_CURSOR_ONOFF_BIT);
...
void HD44780_I2C_Set_Cursor_Blink(bool cursor_is_blink)
{
	if (cursor_is_blink)
	{
		target_hd44780_i2c_object->control_mode_display |=  (1 << _HD44780_I2C_CONTROL_MODE_DISPLAY_B_CURSOR_BLINK_BIT);
	}
	else
	{
		target_hd44780_i2c_object->control_mode_display &= ~(1 << _HD44780_I2C_CONTROL_MODE_DISPLAY_B_CURSOR_BLINK_BIT);
...
{
	target_hd44780_i2c_object->cursor_display_shift_mode |=  (1 << _HD44780_I2C_CURSOR_DISPLAY_SHIFT_MODE_SC_SHIFT_DISPLAY_BIT);
	
	
	if (display_shift_is_right)
	{
		target_hd44780_i2c_object->cursor_display_shift_mode |= (1 << _HD44780_I2C_CURSOR_DISPLAY_SHIFT_MODE_RL_SHIFT_CURSOR_BIT);
	}
	else
	{
		target_hd44780_i2c_object->cursor_display_shift_mode &= ~(1 << _HD44780_I2C_CURSOR_DISPLAY_SHIFT_MODE_RL_SHIFT_CURSOR_BIT);
	...
	_HD44780_I2C_Send_Byte(target_hd44780_i2c_object->cursor_display_shift_mode, _HD44780_I2C_DISPLAY_SEND_COMMAND_MODE); _delay_us(40);
}
