...
void EEPROMI2C_Initialize_Object(EEPROMI2C_t *eeprom_i2c, uint8_t dev_addr, uint16_t max_mem_addr, uint8_t page_size);
...
uint16_t EEPROMI2C_Write_Page(EEPROMI2C_t *eepromi2c, uint16_t memory_addr, const void *page, uint16_t data_size);

uint16_t EEPROMI2C_Fill_Page(EEPROMI2C_t *eepromi2c, uint16_t memory_addr, const uint8_t val, uint16_t num);

uint16_t EEPROMI2C_Read_Page(EEPROMI2C_t *eepromi2c, uint16_t memory_addr, void *page, uint16_t data_size);
