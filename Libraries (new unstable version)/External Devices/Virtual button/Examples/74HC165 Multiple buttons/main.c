...
int main(void)
{
	...
	VirtualButton_Initialize_Object(&vbutton1, &hc165_data, 0, VIRTUALBUTTON_INPUT_LOGICAL_LEVEL_HIGH);
	VirtualButton_Initialize_Object(&vbutton2, &hc165_data, 1, VIRTUALBUTTON_INPUT_LOGICAL_LEVEL_HIGH);
	VirtualButton_Initialize_Object(&vbutton3, &hc165_data, 2, VIRTUALBUTTON_INPUT_LOGICAL_LEVEL_HIGH);
	VirtualButton_Initialize_Object(&vbutton4, &hc165_data, 3, VIRTUALBUTTON_INPUT_LOGICAL_LEVEL_HIGH);
