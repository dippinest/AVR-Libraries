...
// ===============================================================================
//
// Библиотека для опроса реальных или виртуальных кнопок
//
...
// их состояние косвенно (когда кнопки подключены, напрмер, к сдвиговому регистру 74HC165)
//
